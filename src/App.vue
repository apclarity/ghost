...
<template>
  ...
  <nav class="bg-white dark:bg-gray-900">
    <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center">
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ready To Work</span>
      </a>
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="http://google.com" class="block py-2 pl-3 pr-4 text-red-400 rounded md:bg-transparent md:p-0" aria-current="page">Home</a>
          </li>
          <li>
  ...
  <div class="grid grid-cols-2 mx-auto">
    <div class="bg-orange-400 flex items-center justify-center">
      <img class="" src="https://cdn.motor1.com/images/mgl/BXXw8A/s1/2024-bugatti-mistral.webp" alt="">
    </div>
    <div class="bg-lime-400 flex items-center justify-center">
      <img src="https://cdn.antaranews.com/cache/800x533/2021/07/19/lamborghini-aventador-lp-780-4-ultimae.jpg" alt="">
    </div>
  </div>
  <div class="grid grid-cols-2 container mx-auto">
    <div class="h-screen flex items-center my-10">
    ...
    <div class=" bg-cyan-700 flex items-center justify-center my-10">
      <img src="https://images.unsplash.com/photo-1544376798-89aa6b82c6cd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8dmVydGljYWx8ZW58MHx8MHx8&w=1000&q=80" alt="">
    </div>
    <div class="bg-sky-800 flex items-center justify-center h-screen mb-10">
      <span class="text-white">kiri</span>
    </div>
